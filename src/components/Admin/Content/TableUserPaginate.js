...
const TableUserPaginate = (props) => {
    ...
    const { listUsers, handleClickBtnUpdateUser, handleClickBtnViewUser, handleClickBtnDeleteUser, fetchListUsersWithPaginate, pageCount, setCurrentPage, currentPage } = props;
